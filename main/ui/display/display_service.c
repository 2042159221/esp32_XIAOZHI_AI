...
static void display_service_create_base_screen(void)
{
    ...
    lv_obj_set_width(s_hint_label, BSP_LCD_H_RES - 28);
    ...
    lv_obj_set_style_text_font(s_hint_label, &font_puhui_20_4, 0);
    lv_obj_set_style_text_line_space(s_hint_label, 4, 0);
...
void display_service_show_message(const char *title, const char *message)
{
    ...
    lv_obj_set_width(s_message_label, BSP_LCD_H_RES - 28);
    ...
    lv_obj_set_style_text_font(s_message_label, &font_puhui_20_4, 0);
