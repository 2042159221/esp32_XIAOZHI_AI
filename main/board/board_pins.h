...
#define BOARD_AUDIO_I2C_SDA GPIO_NUM_1
#define BOARD_AUDIO_I2C_SCL GPIO_NUM_2
#define BOARD_AUDIO_I2S_PORT I2S_NUM_0
#define BOARD_AUDIO_I2S_BCK GPIO_NUM_3
#define BOARD_AUDIO_I2S_MCK GPIO_NUM_4
#define BOARD_AUDIO_I2S_DI GPIO_NUM_5
#define BOARD_AUDIO_I2S_WS GPIO_NUM_6
#define BOARD_AUDIO_I2S_DO GPIO_NUM_7
#define BOARD_AUDIO_PA_EN GPIO_NUM_8
